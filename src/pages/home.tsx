      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
           <h1 className="text-6xl font-semibold  tracking-tight text-balance text-[#000000] sm:text-8xl">
                Study{' '}
            ...
            <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
              Achieve your academic goals with learning paths, interactive content, and real-time feedback with BuddyAi
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="#"
                className="rounded-md bg-[#666666] px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-[#666666] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Join Now
              </a>
              <a href="#"  className="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-xs ring-1 ring-gray-300 ring-inset hover:bg-gray-50">
                Learn more 
              </a>
            </div>
            <BuddyUI/>
