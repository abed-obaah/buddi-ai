...
export default function Example() {
  ...
  <DialogBackdrop
    transition
    className="fixed inset-0 bg-white/30 backdrop-blur-sm transition-opacity duration-300 ease-linear data-closed:opacity-0"
  />
  ...
  <div className="fixed inset-0 flex">
    ...
    >
      ...
      {/* Sidebar component */}
      <div className="relative flex grow flex-col gap-y-5 overflow-y-auto bg-[#fff] px-6 pb-4 ring-1 ring-white/10">
