  ...
  tiers: [
    {
      ...
      price: 0,
      frequency: '/month',
      description: 'Get started for Free, learn how AiTeacha saves you time and generates tailored resources',
    ...
    },
    {
      ...
      price: 1.97,
      frequency: '/month',
      description: 'Upgrade to AiTeacha Pro for unlimited access to all resources and pro tools',
      features: [
...
export default function Example() {
  return (
    <div className="bg-white">
      ...
      {/* Footer */}
      <footer aria-labelledby="footer-heading" className="bg-[#EFEFEF] rounded-2xl">
